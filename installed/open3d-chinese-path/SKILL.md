...
description: Use when open3d fails to read or write PCD files on Windows with Chinese characters in the path — symptoms include silent empty point cloud returned, encoding error, or file corruption. Fix via tempfile detour.
---
